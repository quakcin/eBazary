...
import { ArrowSmallLeftIcon, ArrowSmallRightIcon, FunnelIcon } from 'react-native-heroicons/outline'
  ...
  return (
    <Viewport navigation={navigation} active='Home' isFullScreen={true}>
      <ScrollView>
          ...
          {isShowingFilters && (
            <View>
              ...
              <View style={{flexDirection: 'row', alignItems: 'center', marginTop: 10}}>
                ...
                <TextInput style={{backgroundColor: '#dedede', width: 50, padding: 5, marginLeft: 5}} placeholder="0"/>
                <Text style={{fontSize: 16}}> do </Text>
                <TextInput style={{backgroundColor: '#dedede', width: 50, padding: 5}} placeholder="100"/>
        ...
        <View style={{marginBottom: 50, marginTop: 25, flexDirection: 'row', alignContent: 'center', justifyContent: 'center', alignSelf: 'center'}}>
          <TouchableOpacity>
            <ArrowSmallLeftIcon
              style={{color: '#000000'}}
              width="30" height="30"
